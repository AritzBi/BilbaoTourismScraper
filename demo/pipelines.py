 		...
 		try:
			if self.cursor.rowcount==0:
				...
				if self.cursor.rowcount==0:
					...
					location_id=self.cursor.fetchone()[0]
				SQLEvent="INSERT INTO HOSTELERY(denom_es,denom_en, denom_eu,location_id, description_es,description_en,description_eu, information_url, HOSTELERY_TYPE, telephone, email, IMAGE_PATH, SOURCE_URL, TIMETABLE_ES, TIMETABLE_EN, TIMETABLE_EU) VALUES (%s,%s,%s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s,%s, %s, %s) returning id;"
